...
import { listCards, listReconciliationReceipts, listStatements, listUnmatchedCompanyPayments } from "@/lib/data/auslagen-cards";
...
export default async function AbgleichPage() {
  ...
  let receipts = [] as Awaited<ReturnType<typeof listReconciliationReceipts>>;
  let error: string | null = null;
  try {
    [cards, statements, companies, payments, receipts] = await Promise.all([listCards(), listStatements(), getCompanies(), listUnmatchedCompanyPayments(), listReconciliationReceipts()]);
