...
export default async function AntraegePage() {
  ...
  return <>
    <header className="aus-head"><span className="aus-eyebrow">Auslagen &amp; Belege</span><h1 className="aus-h1">Anträge</h1><p className="aus-lede">Erstellte und versendete Anträge auf Auslagenerstattung.</p><div className="aus-actions"><Link href="/auslagen/antrag/neu" className="aus-btn aus-btn-primary">Neuen Antrag erstellen</Link>{ctx?.isFinance && <Link href="/auslagen/eingang" className="aus-btn aus-btn-secondary">Eingereichte Anträge ansehen</Link>}</div></header>
